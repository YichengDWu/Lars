...
This is an python version of LAR implement, which strictly follows the formulas in [LAR](http://statweb.stanford.edu/~tibs/ftp/lars.pdf), especially from page 413 to 417.
...
`python main.py -t 100000 -p`  
 To do test   
`python main.py -t xx -test`  or `python main.py -test`
