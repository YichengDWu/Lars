...
This is a python implementation of the LAR method, which strictly follows the formulas in [LEAST ANGLE REGRESSION](http://statweb.stanford.edu/~tibs/ftp/lars.pdf), especially from page 413 to 417.
